...
export const fullStackProjects = [
	{
		...
		tags: [
			...
			},
			{
				id: 4,
				name: "Next auth",
				path: "/assets/logos/next-auth.svg",
			},
			{
				id: 5,
				name: "MongoDB",
...
export const experiences = [
	{
		...
		company: {
			name: "GOAT Developers",
			title: "goatdevelopers.com",
			url: "https://goatdevelopers.com",
			image: "/assets/experiences/goat-developers.png",
			type: "Full-time",
			description:
				"GOAT Developer for AI-powered SaaS, CRM, ERP, and custom software. G.O.A.T. Developers helps businesses scale with tailored tech solutions.",
		},
		date: "Aug 2025 - Oct 2025",
		contents: [
			"Developed core frontend features for a copy-trading platform using Next.js, managing server state with React Query and client state with Zustand.",
			"Integrated Supabase for authentication and user session management, and built reusable, independent and optimized UI components.",
			"Improved application responsiveness and performance, ensuring a smooth and consistent experience across devices and screen sizes.",
		],
	},
	{
		title: "Front-end Developer",
		company: {
			...
			title: "salesqueen.org",
			url: "https://salesqueen.org",
			image: "/assets/experiences/salesqueen.webp",
			type: "Internship",
			description:
				"Salesqueen is the leading website designing and website development company that offers WordPress web development service",
		},
		date: "March 2025 - June 2025",
		contents: [
			"✅ Resolved UI bugs and layout inconsistencies across multiple browsers to improve user experience.",
			"✅ Updated front-end codebase using JavaScript, JQuery and CSS, enhancing design consistency.",
			"✅ Contributed to UI performance improvements and quick deployment fixes with the dev team.",
			"Collaborated with developers to implement responsive UI changes, test fixes across devices, and ensure stable releases in a production environment.",
		],
	},
];
